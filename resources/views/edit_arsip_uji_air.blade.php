        ...
        <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    ...
                    <a class="navbar-brand" href="#pablo">Arsip Daya Uji Air</a>
                </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Edit Data Arsip Uji Air Internal</h4>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table"
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="border: 1px solid rgb(124, 124, 124); padding: 28px;">Bulan</td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="titik_koordinat" class="form-control"
                                                    ...
                                                    value="{{ old('titik_koordinat', $arsipUjiAir->titik_koordinat) }}">
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="number" step="0.01" name="BOD" class="form-control"
                                                    placeholder="BOD" value="{{ old('BOD', $arsipUjiAir->BOD) }}">
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="number" step="0.01" name="COD" class="form-control"
                                                    placeholder="COD" value="{{ old('COD', $arsipUjiAir->COD) }}">
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="number" step="0.01" name="TSS" class="form-control"
                                                    placeholder="TSS" value="{{ old('TSS', $arsipUjiAir->TSS) }}">
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="number" step="0.01" name="DO" class="form-control"
                                                    placeholder="DO" value="{{ old('DO', $arsipUjiAir->DO) }}">
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td style="border: 1px solid rgb(124, 124, 124); padding: 28px;">Total Coliform</td>
                                            <td>
                                                <input type="number" step="0.01" name="total_coli" class="form-control"
                                        ...
                                        <tr>
                                            ...
                                            <td style="border: 1px solid rgb(124, 124, 124); padding: 28px;">Fecal Coliform</td>
                                            <td>
