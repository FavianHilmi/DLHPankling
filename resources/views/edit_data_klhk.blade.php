                            ...
                            <div class="row">
                                <div class="col-md-6 pr-1">
                                    <div class="form-group">
                                        ...
                                        value="{{ old('longitude', $dataKlhk->longitude) }}">
                                    </div>
                                </div>
                                <div class="col-md-6 pr-1">
                                    <div class="form-group">
                                        ...
                                        value="{{ old('latitude', $dataKlhk->latitude) }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3 pr-1">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" name="SO2" id="SO2" class="form-control" placeholder="SO2"
                                ...
                                <div class="col-md-3 px-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" name="CO" id="CO" class="form-control" placeholder="CO"
                                ...
                                <div class="col-md-3 px-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" name="O3" id="O3" class="form-control" placeholder="O3"
                            ...
                            <div class="row">
                                <div class="col-md-3 pr-1">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" name="NO2" id="NO2" class="form-control" placeholder="NO2"
                                        value="{{ old('NO2', $dataKlhk->NO2) }}">
                                    </div>
                                </div>
                                <div class="col-md-3 px-3">
                                    <div class="form-group">
                                        <label for="HC" class="form">HC</label>
                                        <input type="number" step="0.01" name="HC" id="HC" class="form-control" placeholder="HC"
                                        value="{{ old('HC', $dataKlhk->HC) }}">
                                    </div>
                                </div>
                                <div class="col-md-3 px-3">
                                    <div class="form-group">
                                        ...
                                        value="{{ old('PM10', $dataKlhk->PM10) }}">
                                    </div>
                                </div>
                                <div class="col-md-3 px-3">
                                    <div class="form-group">
                                        <label for="PM2_5" class="form">PM2.5</label>
                                        <input type="number" step="0.01" name="PM2_5" id="PM2_5" class="form-control" placeholder="PM2.5"
                                        value="{{ old('PM2_5', $dataKlhk->PM2_5) }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
