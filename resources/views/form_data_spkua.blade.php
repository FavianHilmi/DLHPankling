        ...
        <nav class="navbar navbar-expand-lg navbar-transparent bg-primary navbar-absolute">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    <a class="navbar-brand" href="#pablo">Tambah Data SPKUA</a>
                </div>
            </div>
        </nav>
        <!-- End Navbar -->
                ...
                <div class="col-md-7 mx-auto">
                    <div class="card">
                        <div class="card-header-form">
                            <h5 class="kop-surat" style="font-weight: bold">FORM TAMBAH DATA SPKUA</h5>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('data_spkua.store') }}" method="POST">
                                @csrf
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-6 pr-1">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="lokasi" id="text" class="form-control"
                                ...
                                <div class="row">
                                    <div class="col-md-3 px-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="0.01" name="PM10" id="PM10"
                                                class="form-control" placeholder="PM10" required>
                                        </div>
                                    </div>
                                    <div class="col-md-3 px-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="0.01" name="PM2_5" id="PM2_5"
                                                class="form-control" placeholder="PM2.5" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3 pr-1">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="0.01" name="SO2" id="SO2"
                                                class="form-control" placeholder="SO2" required>
                                        </div>
                                    </div>
                                    <div class="col-md-3 px-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="0.01" name="CO" id="CO"
                                                class="form-control" placeholder="CO" required>
                                        </div>
                                    </div>
                                    <div class="col-md-3 px-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="0.01" name="O3" id="O3"
                                                class="form-control" placeholder="O3" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3 pr-1">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="0.01" name="NO2" id="NO2"
                                                class="form-control" placeholder="NO2" required>
                                        </div>
                                    </div>
                                    <div class="col-md-3 px-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="0.01" name="HC" id="HC"
                                                class="form-control" placeholder="HC" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
