...
Original file is located at
    https://colab.research.google.com/drive/1Jx8_mcVu814iT_Z9C0N_oCFZiWxnUG0x
...
url='https://drive.google.com/file/d/1dmR6hJ8zvfGi-4-i-JZtnSVBHG84070D/view?usp=sharing'
...
# Menyimpan dataframe df menjadi file CSV
df.to_csv('data_ispu.csv', index=False)
...
url='https://drive.google.com/file/d/1xEQao_OJjblW4c5arHeFXkPx-roRUk5W/view?usp=sharing'
url='https://drive.google.com/uc?id=' + url.split('/')[-2]
df3 = pd.read_csv(url)
...
df3_kategori = df3_kategori.drop(columns=['Lokasi', 'Tanggal'], errors='ignore')
...
last_date = pd.to_datetime("2024-10-28")
